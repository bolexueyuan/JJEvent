 ...
 */
package com.github.bolexueyuan.android.analytics.analytics.db;
...
import com.github.bolexueyuan.android.analytics.analytics.db.exception.DbException;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.CursorUtils;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.DbModel;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.ManyToOneLazyLoader;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.OneToManyLazyLoader;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.SqlBuilder;
import com.github.bolexueyuan.android.analytics.analytics.db.sqlite.SqlInfo;
import com.github.bolexueyuan.android.analytics.analytics.db.table.KeyValue;
import com.github.bolexueyuan.android.analytics.analytics.db.table.ManyToOne;
import com.github.bolexueyuan.android.analytics.analytics.db.table.OneToMany;
import com.github.bolexueyuan.android.analytics.analytics.db.table.TableInfo;
...
public class EFinalDb {
    ...
    public <T> List<T> findAllByLimit(Class<T> clazz,int start ,int end) {
        checkTableExist(clazz);
        SqlInfo sqlInfo = SqlBuilder.getSelectSqlByLimit(clazz, start,end);
        return findAllBySql(clazz,sqlInfo.getSql());
    }
    ...
    public <T> T deleteByLimit( Class<T> clazz,int start ,int end) {
        checkTableExist(clazz);
        String  sqlInfo = SqlBuilder.deleteSelectSqlByLimit(clazz, start,end);
        db.execSQL(sqlInfo);
        return null;
    }
    ...
    public <T> T findFirst(Class<T> clazz) {
        ...
        DbModel dbModel = findDbModelBySQL(sql);
        if (dbModel != null) {
            return CursorUtils.dbModel2Entity(dbModel, clazz);
        }
        return null;
    }
