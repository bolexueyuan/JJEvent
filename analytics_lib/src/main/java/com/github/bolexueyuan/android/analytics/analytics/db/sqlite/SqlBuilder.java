 ...
 */
package com.github.bolexueyuan.android.analytics.analytics.db.sqlite;

import android.text.TextUtils;

import com.github.bolexueyuan.android.analytics.analytics.db.exception.DbException;
import com.github.bolexueyuan.android.analytics.analytics.db.table.Id;
...
public class SqlBuilder {
	...
	public static SqlInfo getSelectSqlByLimit(Class<?> clazz, int start, int end){
		TableInfo table= TableInfo.get(clazz);
